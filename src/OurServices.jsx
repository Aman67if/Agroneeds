  ...
  return (
    <div className='min-h-full w-full'>
        ...
        <div className='min-h-[80vh] w-[95%] mt-4 mb-[8rem] xl:mt-14 m-auto pb-4 bg-green-700/30 backdrop-blur-lg border border-white/20 shadow-lg rounded-lg overflow-hidden xl:flex xl:flex-wrap'>
            ...
            <ServicesCard title={"Mzrketing and Promotion"} description={"Agroneeds will support franchisees with national and regional marketing campaigns to raise brand awareness and drive customer traffic."} description2={"Franchise holders are encouraged to engage in local marketing activities, such as participating in agricultural fairs, conducting workshops, and building relationships with local farmers."}/>
        </div>
    </div>
  )
}
